...
Common labels
*/}}
{{- define "espresso-shop-reviews.labels_01" -}}
helm.sh/chart: {{ include "espresso-shop-reviews.chart" . }}
{{ include "espresso-shop-reviews.selectorLabels_01" . }}
{{- if .Chart.AppVersion }}
...
*/}}
{{- define "espresso-shop-reviews.labels_02" -}}
helm.sh/chart: {{ include "espresso-shop-reviews.chart" . }}
{{ include "espresso-shop-reviews.selectorLabels_02" . }}
{{- if .Chart.AppVersion }}
app.kubernetes.io/version: {{ .Chart.AppVersion | quote }}
{{- end }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
...
Selector labels
*/}}
{{- define "espresso-shop-reviews.selectorLabels_01" -}}
version: v1
...
*/}}
{{- define "espresso-shop-reviews.selectorLabels_02" -}}
version: v2
app.kubernetes.io/name: {{ include "espresso-shop-reviews.name" . }}
app.kubernetes.io/instance: {{ .Release.Name }}
{{- end }}
